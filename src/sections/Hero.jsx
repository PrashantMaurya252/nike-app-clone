...
function Hero() {
  ...
  return (
    <section id="home" className="w-full flex xl:flex-row flex-col justify-center min-h-screen gap-10 max-container">
      ...
      <div className=" relative flex-1 flex  justify-center items-center min-h-screen max-xl:py-40 bg-primary bg-hero bg-cover  bg-center"> 
        <img src={bigShoeImg} alt="Shoe-Collection" height={502} width={610}  className=" relative object-contain z-10 "/>
